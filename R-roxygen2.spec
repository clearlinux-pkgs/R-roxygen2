...
Source0  : https://cran.r-project.org/src/contrib/roxygen2_7.1.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641103807
...
/usr/lib64/R/library/roxygen2/tests/testthat/test-rd-examplesIf.txt
