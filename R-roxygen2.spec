...
Version  : 7.0.0
Release  : 77
URL      : https://cran.r-project.org/src/contrib/roxygen2_7.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/roxygen2_7.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573583507
...
/usr/lib64/R/library/roxygen2/tests/testthat/test-rd-examples-dotrun-escape.txt
